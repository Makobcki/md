...
export const workflowCards = [
  {
    key: "generate",
    title: "Generate",
    description: "txt2img, img2img, inpaint, control and VAR token generation.",
    to: "/generate",
  ...
  },
  {
    key: "train",
    title: "Train",
    description: "Edit the active KDL config, resume checkpoints, monitor loss and samples.",
    to: "/train",
  ...
  },
  {
    ...
    description: "Build or rebuild latent cache shards with live throughput metrics.",
    to: "/latents",
  ...
  },
  {
    key: "logs",
    title: "Logs and runs",
    description: "Inspect stdout, stderr, artifacts, configs and metrics from past runs.",
    to: "/files",
    action: "Inspect runs",
  },
];
